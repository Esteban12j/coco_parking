...
export interface Translations {
  ...
  auth: {
    ...
    resetPasswordTargetUser: string;
    resetPasswordTargetUserPlaceholder: string;
    resetPasswordTargetUserRequired: string;
    resetPasswordDevPassword: string;
    resetPasswordDevPasswordPlaceholder: string;
    ...
    resetPasswordDevPasswordIncorrect: string;
  };
  firstRun: {
    title: string;
    description: string;
