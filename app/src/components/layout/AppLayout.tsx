...
import { Car, DollarSign, BarChart3, Tag, Shield, Database, Terminal, Languages, HardDrive, Cpu, LogOut, FileWarning, Palette, CalendarDays } from "lucide-react";
...
const navRoutes = [
  ...
  { to: "/vehicles/today", key: "nav.vehiclesToday" as const, icon: CalendarDays, permission: "vehiculos:entries:read" },
...
const ALLOWED_FALLBACK_ORDER = ["/vehicles", "/vehicles/today", "/till", "/debtors", "/metrics", "/tariffs", "/roles", "/backup"];
